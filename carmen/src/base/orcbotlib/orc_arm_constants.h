...
#define HIP_MAX_THETA 0
#define HIP_MIN_THETA 0
#define HIP_MAX_PWM 0
#define HIP_MIN_PWM 0

#define SHOULDER_MAX_THETA 0
#define SHOULDER_MIN_THETA 0
#define SHOULDER_MAX_PWM 0
#define SHOULDER_MIN_PWM 0

#define ELBOW_MAX_THETA 0
#define ELBOW_MIN_THETA 0
#define ELBOW_MAX_PWM 0
#define ELBOW_MIN_PWM 0
