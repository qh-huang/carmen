				 ...
				 int num_joint_angles)
{
  ...
  joint_angles[1] = shoulder_theta;
  joint_angles[2] = elbow_theta;
  joint_angular_vels[1] = shoulder_angular_velocity;
  joint_angular_vels[2] = elbow_angular_velocity;
...
{ 
  ...
  shoulder_desired_theta = joint_angles[1];
  elbow_desired_theta = joint_angles[2];
  gripper_desired_theta = joint_angles[3];
  carmen_arm_control();
}
