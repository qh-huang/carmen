...
#define carmen_logger_fgetc(X) (carmen_logger_nogz ? fgetc(X) : gzgetc(X))
#define carmen_playback_fgetc(X) (carmen_playback_nogz ? fgetc(X) : gzgetc(X))
#define carmen_logger_feof(X) (carmen_logger_nogz ? feof(X) : gzeof(X))
#define carmen_playback_feof(X) (carmen_playback_nogz ? feof(X) : gzeof(X))
#define carmen_logger_fseek(X,Y,Z) (carmen_logger_nogz ? fseek(X,Y,Z) : gzseek(X,Y,Z))
#define carmen_playback_fseek(X,Y,Z) (carmen_playback_nogz ? fseek(X,Y,Z) : gzseek(X,Y,Z))
#define carmen_logger_ftell(X) (carmen_logger_nogz ? ftell(X) : gztell(X))
#define carmen_playback_ftell(X) (carmen_playback_nogz ? ftell(X) : gztell(X))
#define carmen_logger_fclose(X) (carmen_logger_nogz ? fclose(X) : gzclose(X))
#define carmen_playback_fclose(X) (carmen_playback_nogz ? fclose(X) : gzclose(X))
#define carmen_logger_fread(W,X,Y,Z) (carmen_logger_nogz ? fread(W,X,Y,Z) : (unsigned int)gzread(Z,W,X*Y))
#define carmen_playback_fread(W,X,Y,Z) (carmen_playback_nogz ? fread(W,X,Y,Z) : (unsigned int)gzread(Z,W,X*Y))
#define carmen_logger_fwrite(W,X,Y,Z) (carmen_logger_nogz ? fwrite(W,X,Y,Z) : gzwrite(Z,W,X))
#define carmen_playback_fwrite(W,X,Y,Z) (carmen_playback_nogz ? fwrite(W,X,Y,Z) : gzwrite(Z,W,X))
#define carmen_logger_fgets(X,Y,Z) (carmen_logger_nogz ? fgets(X,Y,Z) : gzgets(Z,X,Y))
#define carmen_playback_fgets(X,Y,Z) (carmen_playback_nogz ? fgets(X,Y,Z) : gzgets(Z,X,Y))
#define carmen_logger_fputc(X,Y) (carmen_logger_nogz ? fputc(X,Y) : gzputc(Y,X))
#define carmen_playback_fputc(X,Y) (carmen_playback_nogz ? fputc(X,Y) : gzputc(Y,X))
