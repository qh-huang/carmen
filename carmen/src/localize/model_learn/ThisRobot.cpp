...
int InitializeThisRobot(int argc __attribute__ ((unused)), 
			char *argv[] __attribute__ ((unused))) {
  return 0;
}

int ConnectOdometry(int argc __attribute__ ((unused)), 
		    char *argv[] __attribute__ ((unused))) {
  return 0;
}

int ConnectLaser(int argc __attribute__ ((unused)), 
		 char *argv[] __attribute__ ((unused))) {
  return 0;
}

int ConnectDrive(int argc __attribute__ ((unused)), 
		 char *argv[] __attribute__ ((unused))) {
  return 0;
}
...
void GetSensation(TSense &sense __attribute__ ((unused))) {
  return;
}


void GetOdometry(TOdo &odometry __attribute__ ((unused))) {
  return;
}


void Drive(double speed __attribute__ ((unused)), 
	   double turn __attribute__ ((unused))) {
  return;
}
