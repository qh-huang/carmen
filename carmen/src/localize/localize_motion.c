					      ...
					      *model)
{
  ...
  return carmen_gaussian_random(downrange_mean, downrange_std_dev);
}
					       ...
					       *model)
{
  ...
  return carmen_gaussian_random(crossrange_mean, crossrange_std_dev);
}
					 ...
					 carmen_localize_motion_model_t *model)
{
  ...
  return carmen_gaussian_random(turn_mean, turn_std_dev);
}
